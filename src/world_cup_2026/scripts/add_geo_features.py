...
# For the rest, we can use capital cities as a fallback.
CITY_GEO_DATA = {
...
# Country to Home City (usually Capital) for travel distance estimation
COUNTRY_HOME_GEO = {
...
def build_geo_features(matches_path, output_path):
    ...
    # If city not found, try to use country capital coordinates (mocked for simplicity here)
    # In a real system, we'd have a much larger lookup.
    
    # Calculate travel distance for home and away teams
    ...
    print(f"Geo features added to {output_path}")

if __name__ == "__main__":
    build_geo_features("processed/matches_with_ratings.csv", "processed/matches_with_geo.csv")
